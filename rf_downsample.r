...
for (i in mtry){
  ...
  try({
    ...
    RF_model1 = randomForest(taxa_train1 ~ MSST+ANC+CA+CL+COND+K+MG+SODIUM+SO4+DOY+LSUB_DMM,
                            data=train1,
                            strata=taxa_train1, sampsize=c(number_presences1, number_presences1),
                            mtry = i,
                            ntree = j)
    ...
    RF_model2 = randomForest(taxa_train2 ~ MSST+ANC+CA+CL+COND+K+MG+SODIUM+SO4+DOY+LSUB_DMM,
                            data=train2,
                            strata=taxa_train2, sampsize=c(number_presences2, number_presences2),
                            mtry = i,
                            ntree = j)
    ...
    RF_model3 = randomForest(taxa_train3 ~ MSST+ANC+CA+CL+COND+K+MG+SODIUM+SO4+DOY+LSUB_DMM,
                            data=train3,
                            strata=taxa_train3, sampsize=c(number_presences3, number_presences3),
                            mtry = i,
                            ntree = j)
    ...
    RF_model4 = randomForest(taxa_train4 ~ MSST+ANC+CA+CL+COND+K+MG+SODIUM+SO4+DOY+LSUB_DMM,
                            data=train4,
                            strata=taxa_train4, sampsize=c(number_presences4, number_presences4),
                            mtry = i,
                            ntree = j)
    ...
    RF_model5 = randomForest(taxa_train5 ~ MSST+ANC+CA+CL+COND+K+MG+SODIUM+SO4+DOY+LSUB_DMM,
                            data=train5,
                            strata=taxa_train5, sampsize=c(number_presences5, number_presences5),
                            mtry = i,
                            ntree = j)
