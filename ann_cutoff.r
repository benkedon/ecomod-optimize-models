...
for (i in size){
  for (j in maxit){
    ...
    # type="raw" instead of "class" gives the class probability.
    ANN_model.prediction1 = predict(ANN_model1, val1, type = "raw")
    ...
    cutoff_predicted_class1<-ifelse(ANN_model.prediction1>=presences_fraction1, 1, 0)
    ...
    AUC1 <- roc.area(numeric_taxa_val1, ANN_model.prediction1)$A
    ...
    # This code is used to predict on the validation dataset and determine final model performance.
    # type="raw" instead of "class" gives the class probability.
    ANN_model.prediction2 = predict(ANN_model2, val2, type = "raw")
    
    # we can now change the cutoff by assigning a 1 classification to any probability greater than the prevalence percentage (i.e. cutoff)
    cutoff_predicted_class2<-ifelse(ANN_model.prediction2>=presences_fraction2, 1, 0)
    # we must declare the levels 1 and 0. Otherwise models without any predicted absences will not be included as a level and the confusion matrix will be incomplete.
    ...
    AUC2 <- roc.area(numeric_taxa_val2, ANN_model.prediction2)$A
    ...
    # This code is used to predict on the validation dataset and determine final model performance.
    # type="raw" instead of "class" gives the class probability.
    ANN_model.prediction3 = predict(ANN_model3, val3, type = "raw")
    
    # we can now change the cutoff by assigning a 1 classification to any probability greater than the prevalence percentage (i.e. cutoff)
    cutoff_predicted_class3<-ifelse(ANN_model.prediction3>=presences_fraction3, 1, 0)
    # we must declare the levels 1 and 0. Otherwise models without any predicted absences will not be included as a level and the confusion matrix will be incomplete.
    ...
    AUC3 <- roc.area(numeric_taxa_val3, ANN_model.prediction3)$A
    ...
    # This code is used to predict on the validation dataset and determine final model performance.
    # type="raw" instead of "class" gives the class probability.
    ANN_model.prediction4 = predict(ANN_model4, val4, type = "raw")
    
    # we can now change the cutoff by assigning a 1 classification to any probability greater than the prevalence percentage (i.e. cutoff)
    cutoff_predicted_class4<-ifelse(ANN_model.prediction4>=presences_fraction4, 1, 0)
    # we must declare the levels 1 and 0. Otherwise models without any predicted absences will not be included as a level and the confusion matrix will be incomplete.
    ...
    AUC4 <- roc.area(numeric_taxa_val4, ANN_model.prediction4)$A
    ...
    # This code is used to predict on the validation dataset and determine final model performance.
    # type="raw" instead of "class" gives the class probability.
    ANN_model.prediction5 = predict(ANN_model5, val5, type = "raw")
    
    # we can now change the cutoff by assigning a 1 classification to any probability greater than the prevalence percentage (i.e. cutoff)
    cutoff_predicted_class5<-ifelse(ANN_model.prediction5>=presences_fraction5, 1, 0)
    # we must declare the levels 1 and 0. Otherwise models without any predicted absences will not be included as a level and the confusion matrix will be incomplete.
    ...
    AUC5 <- roc.area(numeric_taxa_val5, ANN_model.prediction5)$A
